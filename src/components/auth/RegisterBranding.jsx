...
/**
 * Section gauche de la page register - Branding et fonctionnalités
 */
                ...
                <div className="space-y-6 max-w-md">
                    <div className="space-y-3 text-center">
                        ...
                        <p className="text-base text-white/90 leading-relaxed">
                            Créez votre compte gratuitement et commencez à gérer votre élevage de pigeons en toute simplicité.
                        </p>
                    </div>
